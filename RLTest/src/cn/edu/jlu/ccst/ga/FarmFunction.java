 ...
 * @since 2.0
 */
public class FarmFunction extends FitnessFunction {
	...
	public double evaluate(IChromosome a_subject) {
		...
		if (n == 3) {
			double c = ((DoubleGene) a_subject.getGene(0)).doubleValue();
			double w = ((DoubleGene) a_subject.getGene(1)).doubleValue();
			double o = ((DoubleGene) a_subject.getGene(2)).doubleValue();
