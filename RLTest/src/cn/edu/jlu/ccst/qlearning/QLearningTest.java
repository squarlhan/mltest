package cn.edu.jlu.ccst.qlearning;
    ...
    private static void test()
    {
        ...
        for(int i = 0; i < Q_SIZE; i++)
        {
            ...
            do
            {
             ...
             // epsilon greedy
//                newState = epsilon_greedy(currentState, Q_SIZE);
...
//        possibleAction = getRandomAction(Q_SIZE);
        //Epsilon Greedy 
        possibleAction =  epsilon_greedy(currentState,Q_SIZE);
    ...
    private static int epsilon_greedy(final int starter, final int upperBound) {
    	    double e = Math.random();
    	    if(e<eps) {
    	    	     return getRandomAction(upperBound);
    	    }else {
//    	    	     return maximum(starter, true);
    	    	     return getBestAction(starter);
    	    }
    }
    private static int getBestAction(final int starter) {
    	 
    	     int action = 0;
    	     List<Integer> bests = new ArrayList();
    	     int best = 0;
    	     List<Integer> candinates = new ArrayList();
    	     ...
    	     int upperBound = bests.size();
    	     int action_index = new Random().nextInt(upperBound);
    	     return bests.get(action_index);
    }
